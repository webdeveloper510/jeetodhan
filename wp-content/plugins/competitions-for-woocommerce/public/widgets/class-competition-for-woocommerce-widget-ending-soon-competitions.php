<?php
/**
 * Ending Soon competitions Widget
 *
 * @version 1.0.0
 * @extends WP_Widget
 */
...
class Competitions_For_Woocommerce_Widget_Ending_Soon_Competitions extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_cssclass    = 'woocommerce widget_ending_soon_competitions';
		$this->widget_description = __( 'Display a list of your ending soon competitions on your site.', 'competitions_for_woocommerce' );
		$this->widget_id          = 'competitions_ending_soon_competitions';
		$this->widget_name        = __( 'Competitions Ending Soon', 'competitions_for_woocommerce' );

		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Ending soon competitions', 'competitions_for_woocommerce' ),
