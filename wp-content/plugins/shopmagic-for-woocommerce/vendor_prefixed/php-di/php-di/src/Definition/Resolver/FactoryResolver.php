...
namespace ShopMagicVendor\DI\Definition\Resolver;
...
use ShopMagicVendor\DI\Invoker\FactoryParameterResolver;
use ShopMagicVendor\Invoker\Exception\NotCallableException;
use ShopMagicVendor\Invoker\Exception\NotEnoughParametersException;
