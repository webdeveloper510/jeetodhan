...
return static function ( \WPDesk\ShopMagic\Components\Routing\RoutesConfigurator $routes ) {
	...
	$routes->add( '/guests/(?P<id>[\d]+)' )
	       ...
	       ->methods( 'DELETE' )
	       ->controller( [ Controller\CustomerController::class, 'delete_guest' ] );

	$routes->add( '/guests/count' )
	       ->controller( [ Controller\CustomerController::class, 'guests_count' ] );

	$routes->add( '/automations/recipes' )
	       ->controller( [ Controller\RecipesController::class, 'index' ] );
	...
	$routes->add( '/subscribers' )
	       ...
	       ->controller( [ Controller\SubscribersController::class, 'index' ] );
