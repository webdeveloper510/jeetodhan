			...
			$messages = maybe_serialize(
				array(
					...
					self::REGISTER_WITH_US              => mo_(
						"<u><i><a href='{{url}}'>Register or Login with miniOrange</a></i></u>
					...
					self::LOW_TRANSACTION_ERROR         => mo_( 'There was an error in sending the OTP to the given Email/Phone Number. Please Try Again or contact site Admin.' ),
					self::LOW_TRANSACTION_ALERT         => mo_(
						'You will get the below error once you exhaust your remaining transactions:'
					),
