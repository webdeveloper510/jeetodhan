							...
							<tr>
								...
								<td>
									<input  class="" ' . esc_attr( $disabled ) . ' 
									        type="checkbox" 
									        name="' . esc_attr( $enable_disable_tag ) . '" 
										    id="' . esc_attr( $enable_disable_tag ) . '" 
										    style="" 
										    value="1" ' . esc_attr( $enable_disable ) . '>
									' . esc_html( mo_( 'Enable this SMS Notification' ) ) . '
								</td>
							</tr>
							<tr>
								<td style="width:160px">
								    <h4>' . esc_html( mo_( 'Phone Meta Key' ) );
										mo_draw_tooltip(
								...
								<td>
									<input  style="width:100%" 
									        ' . esc_attr( $disabled ) . ' 
									        type="text" 
									        name="' . esc_attr( $recipient_tag ) . '" 
										    id="' . esc_attr( $recipient_tag ) . '" 
										    style="" 
										    value="' . esc_attr( $recipient_value ) . '"/>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<textarea   ' . esc_attr( $disabled ) . ' 
									            id="' . esc_attr( $textarea_tag ) . '" 
									            class="mo_registration_table_textbox" 
										        name="' . esc_attr( $textarea_tag ) . '" 
										        placeholder=" ' . esc_attr( $sms_settings->default_sms_body ) . '" />'
										. esc_html( $sms_settings->sms_body ) .
										'</textarea>
									<span id="characters">
