...
class Participate_Qty extends Base_Widget {

	public function get_name() {
		return 'woocommerce-product-participate-qty';
	}

	public function get_title() {
		return __( 'Competition Lucky Dip Qty', 'competitions_for_woocommerce' );
	}

	public function get_icon() {
		return 'eicon-product-participate-qty';
	}
	...
	protected function render() {
		...
		<div class="elementor-participate-qty elementor-product-<?php echo esc_attr( wc_get_product()->get_type() ); ?>">
			<?php echo do_shortcode( '[competition_lucky_dip_button qty="' . intval( $settings['quantity'] ) . '" label="' . esc_html( $settings['label'] ) . '"]' ); ?>
		</div>
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'prefix_class' => 'elementor-participate-qty%s--align-',
			]
		);
