            ...
            <header class="dokan-dashboard-header dokan-clearfix">
                <h1 class="entry-title">
                    ...
                    <?php if ( $_visibility === 'hidden' ) : ?>
                        <span class="dokan-right dokan-label dokan-label-default dokan-product-hidden-label"><i class="far fa-eye-slash"></i> <?php esc_html_e( 'Hidden', 'pomana' ); ?></span>
                    <?php endif; ?>
                </h1>
            </header><!-- .entry-header -->
                ...
                <?php if ( apply_filters( 'dokan_can_post', true ) ) : ?>
                    <?php if ( dokan_is_seller_enabled( get_current_user_id() ) ) : ?>
                        <form class="dokan-product-edit-form" role="form" method="post" id="post">
                                ...
                                <div class="content-half-part dokan-product-meta">
                                    ...
                                    <div id="dokan-product-title-area" class="dokan-form-group">
                                        ...
                                        dokan_post_input_box(
                                            ...
                                            'post_title',
                                            [
                                                'placeholder' => __( 'Product name..', 'pomana' ),
                                                'value'       => $post_title,
                                            ]
                                        );
                                        ?>
                                    ...
                                    <?php $product_types = apply_filters( 'dokan_product_types', [ 'simple' => __( 'Simple', 'pomana' ) ] ); ?>
                                    ...
                                    ?>
                                        <div class="content-half-part lottery-checkbox">
                                            <label>
                                                <input type="checkbox" <?php if( $_product->is_type( 'lottery' ) ) {echo esc_attr__('checked', 'pomana');} ?> class="pomana_is_lottery _is_lottery" name="_lottery" id="_lottery"> <?php esc_html_e( 'Lottery', 'pomana' ); ?> <i class="fas fa-question-circle tips" aria-hidden="true" data-title="<?php esc_attr_e( 'Enable Lottery for this current product', 'pomana' ); ?>"></i>
                                            </label>
                                        </div>
                                        ...
                                        <div class="sale_price_dates_fields dokan-clearfix dokan-form-group <?php echo ( ! $show_schedule ) ? 'dokan-hide' : ''; ?>">
                                            <div class="content-half-part from">
                                                <div class="dokan-input-group">
                                                    ...
                                                    <input type="text" name="_sale_price_dates_from" class="dokan-form-control dokan-start-date" value="<?php echo esc_attr( $_sale_price_dates_from ); ?>" maxlength="10" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" placeholder="<?php esc_html_e( 'YYYY-MM-DD', 'pomana' ); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="content-half-part to">
                                                <div class="dokan-input-group">
                                                    ...
                                                    <input type="text" name="_sale_price_dates_to" class="dokan-form-control dokan-end-date" value="<?php echo esc_attr( $_sale_price_dates_to ); ?>" maxlength="10" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" placeholder="<?php esc_html_e( 'YYYY-MM-DD', 'pomana' ); ?>">
                                                </div>
                                            </div>
                                    ...
                                    <div class="dokan-form-group">
                                        <label for="product_tag_edit" class="form-label"><?php esc_html_e( 'Tags', 'pomana' ); ?></label>
                                        <?php
                                        ...
                                        $tags_placeholder = 'on' === $can_create_tags ? __( 'Select tags/Add tags', 'pomana' ) : __( 'Select product tags', 'pomana' );
                            ...
                            <?php #Begin: Blue Box iBid lotterys hook ?>
                            <?php do_action('pomana_dokan_edit_product_before_short_description', $post->ID); ?>
                            <?php #End: Blue Box iBid lotterys hook ?>
                            ...
                            <input type="submit" name="dokan_update_product" id="publish" class="dokan-btn dokan-btn-theme dokan-btn-lg dokan-right" value="<?php esc_attr_e( 'Save Product', 'pomana' ); ?>"/>
