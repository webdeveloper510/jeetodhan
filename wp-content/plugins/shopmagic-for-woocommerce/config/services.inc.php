...
return [
	...
	'hookable.init'                   => [
		autowire( AjaxHandler::class )
			->constructor( static function ( ContainerInterface $c ) {
		...
		autowire( ListsOnCheckout::class )
			->constructorParameter( 'renderer', get( 'renderer.marketing' ) ),
	...
	CurrentCustomer::class            => autowire(),
	...
	'renderer.marketing'  => static function () {
		return new SimplePhpRenderer(
			TemplateResolver::for_public( 'marketing-lists' )
		);
	},
	...
	OutcomeMetaRepository::class => autowire()
		->constructorParameter( 'denormalizer',
	...
	TrackedEmailObjectManager::class => autowire()
		...
		->constructorParameter( 'normalizer',
	...
	'routesConfigurator.api'    => static function () {
		...
		$configurator->authorize( static function () {
	...
	ConfirmationDispatcher::class => autowire()
		->constructorParameter( 'renderer', get( 'renderer.emails' ) ),
	'renderer.emails'             => static function () {
		return new SimplePhpRenderer(
