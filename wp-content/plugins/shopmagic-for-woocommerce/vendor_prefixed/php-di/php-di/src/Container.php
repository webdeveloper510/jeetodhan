...
use ShopMagicVendor\DI\Definition\FactoryDefinition;
use ShopMagicVendor\DI\Definition\Helper\DefinitionHelper;
use ShopMagicVendor\DI\Definition\InstanceDefinition;
use ShopMagicVendor\DI\Definition\ObjectDefinition;
use ShopMagicVendor\DI\Definition\Resolver\DefinitionResolver;
use ShopMagicVendor\DI\Definition\Resolver\ResolverDispatcher;
use ShopMagicVendor\DI\Definition\Source\DefinitionArray;
use ShopMagicVendor\DI\Definition\Source\MutableDefinitionSource;
use ShopMagicVendor\DI\Definition\Source\ReflectionBasedAutowiring;
use ShopMagicVendor\DI\Definition\Source\SourceChain;
use ShopMagicVendor\DI\Definition\ValueDefinition;
use ShopMagicVendor\DI\Invoker\DefinitionParameterResolver;
use ShopMagicVendor\DI\Proxy\ProxyFactory;
use InvalidArgumentException;
use ShopMagicVendor\Invoker\Invoker;
use ShopMagicVendor\Invoker\InvokerInterface;
use ShopMagicVendor\Invoker\ParameterResolver\AssociativeArrayResolver;
use ShopMagicVendor\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
