...
namespace ShopMagicVendor\WPDesk\Dashboard;
...
final class DashboardWidget
{
    ...
    {
        wp_add_dashboard_widget(self::ID, __('Grow your business with WP Desk', 'wpdesk_ltv_dashboard_widget'), [$this, 'widget_output'], null, null, 'normal', 'high');
    }
