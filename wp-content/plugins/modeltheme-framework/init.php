...
function add_theme_scripts() {
	wp_enqueue_script( 'script1', CMB_META_BOX_URL . '/js/jquery.magnific-popup.min.js', array ( 'jquery' ), 1.1, true);
	wp_enqueue_script( 'script2', CMB_META_BOX_URL . '/js/modeltheme-custom.js', array ( 'jquery' ), 1.1, true);
}
