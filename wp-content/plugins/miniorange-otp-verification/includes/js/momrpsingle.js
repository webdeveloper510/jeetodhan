jQuery(document).ready(function () {
    ...
    $mo("form.mepr-signup-form").each(function () {
        ...
        let fieldID = $mo("input[name='mepr_product_id']").val();
            ...
            let verifyfield = '<div style="display:none;" class="mp-form-row mo_verify_otp_field">'+
                                '<div class="mp-form-label">'+
                                '<label for="mo_verify_otp_field">Enter Verification Code:*</label>'+
                                '<span class="cc-error" style="display: none;">Verification Code Required</span>'+
                                '</div>'+
                                '<input type="text" name="mo_verify_otp_field" id="mo_verify_otp_field" class="mepr-form-input" value="" required>'+
                                '</div>';
