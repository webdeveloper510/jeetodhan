    ...
    <div id="mo-new-pricing-page" class="mo-new-pricing-page mt-mo-4 bg-white rounded-md">
        ...
        <div>
            <div class="mo-section-header bg-slate-100">
                ...
                <input class="mo-button secondary" type="button" ' . esc_attr( $disabled ) . ' name="check_btn" id="check_btn" value="' . esc_attr( mo_( 'Check License' ) ) . '"/>
            </div>
            <!--  PRICING SECTION  -->
    ...
    <div class="mo_registration_divided_layout mo-otp-full">
        <div class="mo_registration_pricing_layout mo-otp-center">
            ...
            <div id="disclaimer" style="margin-bottom:15px;">
                <span style="font-size:15px;">
                    <b>' . esc_html( mo_( ' SMS gateway' ) ) . '</b>
                        ' . esc_html( mo_( '  is a service provider for sending SMS on your behalf to your users.' ) ) . '<br>
                    <b>' . esc_html( mo_( ' SMTP gateway' ) ) . '</b>
                        ' . esc_html( mo_( '  is a service provider for sending Emails on your behalf to your users.' ) ) . '<br><br>
                    *' . esc_html( mo_( ' Transaction prices may very depending on country. If you want to use more than 50k transactions, mail us at' ) ) . '
                        <a href="mailto:' . esc_url( MoConstants::SUPPORT_EMAIL ) . '"><b>' . esc_html( MoConstants::SUPPORT_EMAIL ) . '</b></a>
                        ' . esc_html( mo_( ' or submit a support request using the Need Help button.' ) ) . '<br/><br/>
                    **' . wp_kses( mo_( ' If you want to <b>use miniorange SMS/SMTP gateway</b>, and your country is not in list, mail us at' ), array( 'b' => array() ) ) . ' <a href="mailto:' . esc_url( MoConstants::SUPPORT_EMAIL ) . '">
                            <b>' . esc_html( MoConstants::SUPPORT_EMAIL ) . '</b></a>
                            ' . esc_html( mo_( ' or submit a support request using the Need Help button.' ) ) . '
                            ' . esc_html( mo_( ' We will get back to you promptly.' ) ) . '<br><br>
                    ***<b>' . esc_html( mo_( ' Custom integration charges' ) ) . '</b>' . esc_attr(
								mo_(
									'  will be applied for supporting a registration form which is not already supported
                            by our plugin. Each request will be handled on a per case basis.'
								)
							) . '<br>
                </span>
            </div>
     ...
     <div class="mo_registration_divided_layout mo-otp-full" id="otp_payment">
       <div class="mo_registration_pricing_layout mo-otp-center" id="otp_pay_method">
           <h3>' . esc_html( mo_( ' Supported Payment Methods :' ) ) . '</h3><hr>
           ...
           <div class="mo-card-pricing mo-animation">
                ...
                <img  src="' . esc_url( MOV_CARD ) . '"  style="size: landscape;width: 100px;
           height: 27px; margin-bottom: 4px;margin-top: 4px;opacity: 1;padding-left: 8px;">
                ...
                <p><i><b>For guide <a href=' . esc_url( MoConstants::FAQ_PAY_URL ) . ' target="blank">Click Here.</a></b></i></p>
                </div>
            </div>
          <div class="mo-card-pricing mo-animation">
                <div class="mo-card-pricing-header">
                <img  src="' . esc_url( MOV_PAYPAL ) . '"  style="size: landscape;width: 100px;
           height: 27px; margin-bottom: 4px;margin-top: 4px;opacity: 1;padding-left: 8px;">
                </div>
                <hr style=" margin-left: -26px; margin-right: -26px;border-top: 4px solid #fff;">
                <div class="mo-card-pricing-body">
          ...
          <div class="mo-card-pricing mo-animation">
                <div class="mo-card-pricing-header">
                <img  src="' . esc_url( MOV_NETBANK ) . '"  style="size: landscape;width: 100px;
           height: 27px; margin-bottom: 4px;margin-top: 4px;opacity: 1;padding-left: 8px;">
                </div>
                <hr style=" margin-left: -26px; margin-right: -26px;border-top: 4px solid #fff;">
                <div class="mo-card-pricing-body">
             ...
             <div class="mo-supportnote">
                ...
                <p>For more information about payment methods visit <a href=' . esc_url( MoConstants::FAQ_PAY_URL ) . ' target="blank">Supported Payment Methods.</a></p></p>
                </div>
     </div>
 </div>
    <div class="mo_registration_divided_layout mo-otp-full">
        <div class="mo_registration_pricing_layout mo-otp-center">
            <h3>' . esc_html( mo_( ' Return Policy (Please read the refund policy before upgrading to any plan)' ) ) . '</h3>
            Xecurify warrants that the software will materially confirm the accompanying documentation for a period of 7 days from the date of initial delivery.<br>
            At Xecurify, the customer will only be able to claim if the refund has been raised by the Customer within 10 days from the date of purchase, only under the following circumstances:
            <p>
                <ol>
                    <li>' . esc_html( mo_( 'If the software or the features you have purchased is not working as advertised on the website/ marketplace and you have attempted to resolve the issues with our support team.' ) ) . '</li>
                    <li>' . esc_html( mo_( 'You have purchased the wrong license or Xecurify/miniOrange product and informed us within a period of 10 days from your purchase.' ) ) . '</li>
                </ol>
                </p>
                The Customer is not eligible for the refund under all the following circumstances:
                <p>
                <ol>
                <li>' . esc_html( mo_( 'The Software is not used in accordance with Xecurify\'s instructions.' ) ) . '</li>
                <li>' . esc_html( mo_( 'The Software defect has been caused by any of Customer\'s malfunctioning equipment or Customer provided software.' ) ) . '</li>
                <li>' . esc_html( mo_( 'Customer has made modifications to the Software not expressly authorized in writing by Xecurify. ' ) ) . '</li>
                <li>' . esc_html( mo_( 'Software is not working due to customers environmental changes.' ) ) . '</li>
                <li>' . esc_html( mo_( 'Combined the software with other products. ' ) ) . '</li>
                <li>' . esc_html( mo_( 'Customer no longer requires the software after the purchase or changes his/her requirements towards the services. ' ) ) . '</li>
                <li>' . esc_html( mo_( 'In cases where the Customer has willingly purchased the software after taking the demo/trial from the Xecurify team.' ) ) . '</li>
                </ol>
                If refunded, Customer\'s license in the use of the defective Software shall be terminated and the defective Software shall be returned to Xecurify immediately after receipt of the refund. Xecurify does not warrant and explicitly states that the operation of the Software will be uninterrupted or error free, or that all software defects can be corrected.<br>
                Please email us at <a href="mailto:' . esc_url( MoConstants::SUPPORT_EMAIL ) . '">' . esc_html( MoConstants::SUPPORT_EMAIL ) . '</a> for any queries regarding the return policy. If you have any doubts regarding the licensing plans, you can mail us at <a href="mailto:' . esc_url( MoConstants::SUPPORT_EMAIL ) . '">' . esc_html( MoConstants::SUPPORT_EMAIL ) . '</a> or submit a query using the support form.
            </p>
        </div>
    </div>
