...
class Archive_Competitions extends Products {

	public function get_name() {
		
		return 'wc-archive-competitions';
	}

	public function get_title() {
		return __( 'Archive Competitions', 'elementor-pro' );
	}
	...
	protected function register_controls() {
		...
		$this->update_control(
			'competitions_class',
			[
				'prefix_class' => 'elementor-competitions-grid elementor-',
			]
		);
