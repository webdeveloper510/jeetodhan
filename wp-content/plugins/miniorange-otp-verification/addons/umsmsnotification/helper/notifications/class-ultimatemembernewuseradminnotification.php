...
if ( ! class_exists( 'UltimateMemberNewUserAdminNotification' ) ) {
	...
	class UltimateMemberNewUserAdminNotification extends SMSNotification {
		...
		protected function __construct() {
			...
			$this->available_tags    = '{site-name},{username},{accountpage-url},{email},{firtname},{lastname}';
		...
		public function send_sms( array $args ) {
			...
			$first_name    = um_user( 'first_name' );// phpcs::ignore -- Default function of Ultimate Member Plugin.
			$last_name     = um_user( 'last_name' );// phpcs::ignore -- Default function of Ultimate Member Plugin.
