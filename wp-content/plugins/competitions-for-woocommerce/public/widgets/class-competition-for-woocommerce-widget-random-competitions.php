...
class Competitions_For_Woocommerce_Widget_Random_Competitions extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_cssclass    = 'woocommerce woocommerce_random_competitions';
		$this->widget_description = __( 'Display a list of random competitions on your site.', 'competitions_for_woocommerce' );
		$this->widget_id          = 'competitions_random_competitions';
		$this->widget_name        = __( 'Competitions Random Competitions', 'competitions_for_woocommerce' );

		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Random competitions', 'competitions_for_woocommerce' ),
