...
if (!\class_exists('ShopMagicVendor\\WPDesk_Basic_Requirement_Checker')) {
    ...
    class WPDesk_Basic_Requirement_Checker implements WPDesk_Requirement_Checker
    {
        ...
        {
            return \defined('ShopMagicVendor\\WC_VERSION') && \version_compare(\ShopMagicVendor\WC_VERSION, $min_version, '>=');
        }
        /**
        ...
        private function prepare_plugin_repository_install_url($plugin_info)
        {
            ...
            if (\function_exists('ShopMagicVendor\\wp_nonce_url') && \function_exists('ShopMagicVendor\\wp_create_nonce')) {
        ...
        private function prepare_plugin_repository_require_notice($plugin_info)
        {
            ...
            if (!self::is_wp_plugin_active($name)) {
                ...
                if (\function_exists('ShopMagicVendor\\wp_create_nonce')) {
