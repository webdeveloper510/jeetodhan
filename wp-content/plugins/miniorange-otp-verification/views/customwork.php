...
echo '
               <div class="mo_registration_table_layout mo-otp-center" style="margin-top:2%">
                  <h3 style="text-align: center;"><b>' . esc_html( mo_( 'CUSTOM WORK' ) ) . '</b></h3>
                  <hr>
                <h4 class="mo_otp_note" style="text-align: center;">' . esc_html( mo_( 'Need any customization in our plugin? Just send us a query and we will get in touch.' ) ) . '</h4>
...
echo '                      <div class="mo_support_input_container" style="border-bottom: none;"  >
                                <span class="mo_support_input_label" style="color: #000000;">Your Email</span>
                                <input type="email" class="mo_support_input" id="query_email" style="border: 1px solid #ddd;" name="query_email" value="' . esc_attr( $email ) . '" placeholder="' . esc_html( mo_( 'Enter your Email' ) ) . '" required />
                            </div>
                             <div class="mo_support_input_container" style="border-bottom: none;">
                                ...
                                <input type="text" class="mo_support_input" name="query_phone" id="query_phone" style="border: 1px solid #ddd;" value="' . esc_attr( $phone ) . '"
                                    placeholder="' . esc_attr( mo_( 'Enter your phone' ) ) . '"/>
                            </div>
                            <div class="mo_support_input_container" style="border-bottom: none;">
                                <span class="mo_support_input_label" style="color: #000000;">Enter Your Use Case</span>
                                    <textarea id="query" name="query" class="mo_support_text" 
                                        ...
                                        placeholder="' . esc_attr( mo_( 'Write your usecase here...' ) ) . '"></textarea>
                            </div>
