...
if ( !isset( $post->ID ) && ! isset( $_GET['product_id'] ) ) {
    wp_die( esc_html__( 'Access Denied, No product found', 'pomana' ) );
}
...
if ( ! dokan_is_product_author( $post_id ) ) {
    wp_die( esc_html__( 'Access Denied', 'pomana' ) );
    exit();
}
        ...
        <div class="dokan-dashboard-content dokan-product-edit">
            ...
            <header class="dokan-dashboard-header dokan-clearfix">
                <h1 class="entry-title">
                    <?php esc_html_e( 'Edit Product', 'pomana' ); ?>
                    ...
                    <?php if ( $post->post_status == 'publish' ) { ?>
                        <span class="dokan-right">
                            <a class="dokan-btn dokan-btn-theme dokan-btn-sm" href="<?php echo esc_url( get_permalink( $post->ID ) ); ?>" target="_blank"><?php esc_html_e( 'View Product', 'pomana' ); ?></a>
                        </span>
                    <?php } ?>

                    <?php if ( $_visibility == 'hidden' ) { ?>
                        <span class="dokan-right dokan-label dokan-label-default dokan-product-hidden-label"><i class="fas fa-eye-slash"></i> <?php esc_html_e( 'Hidden', 'pomana' ); ?></span>
                    <?php } ?>
                </h1>
            </header><!-- .entry-header -->
            ...
            <div class="product-edit-new-container product-edit-container">
                <?php if ( Dokan_Template_Products::$errors ) { ?>
                    <div class="dokan-alert dokan-alert-danger">
                        ...
                        <?php foreach ( Dokan_Template_Products::$errors as $error) { ?>
                            <strong><?php esc_html_e( 'Error!', 'pomana' ); ?></strong> <?php echo esc_html( $error ) ?>.<br>
                        <?php } ?>
                    </div>
                <?php } ?>
                ...
                <?php if ( isset( $_GET['message'] ) && $_GET['message'] == 'success') { ?>
                    <div class="dokan-message">
                        ...
                        <strong><?php esc_html_e( 'Success!', 'pomana' ); ?></strong> <?php esc_html_e( 'The product has been saved successfully.', 'pomana' ); ?>

                        <?php if ( $post->post_status == 'publish' ) { ?>
                            <a href="<?php echo esc_url( get_permalink( $post_id ) ); ?>" target="_blank"><?php esc_html_e( 'View Product &rarr;', 'pomana' ); ?></a>
                        <?php } ?>
                    </div>
                ...
                if ( $can_sell ) {
                    ...
                    if ( dokan_is_seller_enabled( get_current_user_id() ) ) { ?>
                        <form class="dokan-product-edit-form" role="form" method="post">
                            ...
                            <div class="dokan-form-top-area">
                                ...
                                <div class="content-half-part dokan-product-meta">
                                    ...
                                    <div class="dokan-form-group">
                                        ...
                                        <label for="post_title" class="form-label"><?php esc_html_e( 'Title', 'pomana' ); ?></label>
                                        <?php dokan_post_input_box( $post_id, 'post_title', array( 'placeholder' => __( 'Product name..', 'pomana' ), 'value' => $post_title ) ); ?>
                                        <div class="dokan-product-title-alert dokan-hide">
                                            <?php esc_html_e( 'Please enter product title!', 'pomana' ); ?>
                                        </div>
                                    </div>
                                    ...
                                    if (class_exists('Dokan_Pro')) {
                                        if ( is_array( $product_types ) ){
                                            $lottery_array = array('lottery' => esc_html__('Lottery', 'pomana'));
                                            if (!array_key_exists('lottery', $product_types)) {
                                                $product_types = array_merge($product_types, $lottery_array);
                                            }
                                        }
                                    }
                                    ?>
                                    ...
                                    <?php if ( is_array( $product_types ) ): ?>
                                        <div class="dokan-form-group">
                                            <label for="product_type" class="form-label"><?php esc_html_e( 'Product Type', 'pomana' ); ?> <i class="fas fa-question-circle tips" aria-hidden="true" data-title="<?php esc_html_e( 'Choose Variable if your product has multiple attributes - like sizes, colors, quality etc', 'pomana' ); ?>"></i></label>
                                    ...
                                    if (!class_exists('Dokan_Pro')) {
                                    ?>
                                        <div class="content-half-part lottery-checkbox">
                                            <label>
                                                <input type="checkbox" <?php if( $_product->is_type( 'lottery' ) ) {echo esc_attr__('checked', 'pomana');} ?> class="pomana_is_lottery _is_lottery" name="_lottery" id="_lottery"> <?php esc_html_e( 'Lottery', 'pomana' ); ?> <i class="fas fa-question-circle tips" aria-hidden="true" data-title="<?php esc_attr_e( 'Enable Lottery for the current product', 'pomana' ); ?>"></i>
                                            </label>
                                        </div>
                                    ...
                                    <div class="show_if_simple dokan-clearfix">
                                        ...
                                        <div class="dokan-form-group dokan-clearfix dokan-price-container">
                                            ...
                                            <div class="content-half-part regular-price">
                                                <label for="_regular_price" class="form-label"><?php esc_html_e( 'Price', 'pomana' ); ?>
                                                    <span
                                                        ...
                                                        data-product-id="<?php echo esc_attr( $post_id ); ?>">
                                                            ( <?php esc_html_e( ' You Earn : ', 'pomana' ) ?><?php echo esc_html( get_woocommerce_currency_symbol() ); ?>
                                                ...
                                                <div class="dokan-input-group">
                                                    ...
                                                    <?php dokan_post_input_box( $post_id, '_regular_price', array( 'class' => 'dokan-product-regular-price', 'placeholder' => __( '0.00', 'pomana' ) ), 'number' ); ?>
                                                </div>
                                            </div>

                                            <div class="content-half-part sale-price">
                                                <label for="_sale_price" class="form-label">
                                                    <?php esc_html_e( 'Discounted Price', 'pomana' ); ?>
                                                    <a href="#" class="sale_schedule <?php echo (esc_attr($show_schedule) ) ? 'dokan-hide' : ''; ?>"><?php esc_html_e( 'Schedule', 'pomana' ); ?></a>
                                                    <a href="#" class="cancel_sale_schedule <?php echo ( ! $show_schedule ) ? 'dokan-hide' : ''; ?>"><?php esc_html_e( 'Cancel', 'pomana' ); ?></a>
                                                </label>

                                                <div class="dokan-input-group">
                                                    <span class="dokan-input-group-addon"><?php echo esc_html( get_woocommerce_currency_symbol() ); ?></span>
                                                    <?php dokan_post_input_box( $post_id, '_sale_price', array( 'class' => 'dokan-product-sales-price','placeholder' => __( '0.00', 'pomana' ) ), 'number' ); ?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="dokan-form-group dokan-clearfix dokan-price-container">
                                            <div class="dokan-product-less-price-alert dokan-hide">
                                                <?php esc_html_e('Product price can\'t be less than the vendor fee!', 'pomana' ); ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="sale_price_dates_fields dokan-clearfix dokan-form-group <?php echo ( ! $show_schedule ) ? 'dokan-hide' : ''; ?>">
                                            <div class="content-half-part from">
                                                <div class="dokan-input-group">
                                                    <span class="dokan-input-group-addon"><?php esc_html_e( 'From', 'pomana' ); ?></span>
                                                    <input type="text" name="_sale_price_dates_from" class="dokan-form-control datepicker" value="<?php echo esc_attr( $_sale_price_dates_from ); ?>" maxlength="10" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" placeholder="<?php esc_html_e( 'YYYY-MM-DD', 'pomana' ); ?>">
                                                </div>
                                            </div>

                                            <div class="content-half-part to">
                                                <div class="dokan-input-group">
                                                    <span class="dokan-input-group-addon"><?php esc_html_e( 'To', 'pomana' ); ?></span>
                                                    <input type="text" name="_sale_price_dates_to" class="dokan-form-control datepicker" value="<?php echo esc_attr( $_sale_price_dates_to ); ?>" maxlength="10" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" placeholder="<?php esc_html_e( 'YYYY-MM-DD', 'pomana' ); ?>">
                                                </div>
                                            </div>
                                    ...
                                    <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                        <div class="dokan-form-group">
                                            <label for="product_cat" class="form-label"><?php esc_html_e( 'Category', 'pomana' ); ?></label>
                                            <?php
                                            $product_cat = -1;
                                            $term = array();
                                            ...
                                            $category_args =  array(
                                                'show_option_none' => __( '- Select a category -', 'pomana' ),
                                                'hierarchical'     => 1,
                                                'hide_empty'       => 0,
                                                'name'             => 'product_cat',
                                                'id'               => 'product_cat',
                                        ...
                                        ?>
                                            <div class="dokan-product-cat-alert dokan-hide">
                                                <?php esc_html_e('Please choose a category!', 'pomana' ); ?>
                                            </div>
                                        </div>
                                    <?php elseif ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'multiple' ): ?>
                                        <div class="dokan-form-group">
                                            ...
                                            echo str_replace( '<select', '<select data-placeholder="' . esc_html__( 'Select product category', 'pomana' ) . '" multiple="multiple" ', $drop_down_category );
                                            ?>
                                        </div>
                                    <?php endif; ?>

                                    <div class="dokan-form-group">
                                        <label for="product_tag" class="form-label"><?php esc_html_e( 'Tags', 'pomana' ); ?></label>
                                        <?php
                                        ...
                                        echo str_replace( '<select', '<select data-placeholder="' . esc_html__( 'Select product tags', 'pomana' ) . '" multiple="multiple" ', $drop_down_tags );
                                ...
                                <div class="content-half-part featured-image">
                                    ...
                                    <div class="dokan-feat-image-upload dokan-new-product-featured-img">
                                        ...
                                        <div class="instruction-inside<?php echo esc_attr( $instruction_class ); ?>">
                                            ...
                                            <a href="#" class="dokan-feat-image-btn btn btn-sm"><?php esc_html_e( 'Upload a product cover image', 'pomana' ); ?></a>
                                        </div>
                                        ...
                                        <div class="image-wrap<?php echo esc_attr( $wrap_class ); ?>">
                                            ...
                                            <?php } else { ?>
                                                <img height="" width="" src="" alt="<?php esc_attr_e( 'Image', 'pomana' ); ?>">
                                            <?php } ?>
                                        </div>
                                                        ...
                                                        if ( $gallery ) {
                                                            foreach ($gallery as $image_id) {
                                                                ...
                                                                <li class="image" data-attachment_id="<?php echo esc_attr( $image_id ); ?>">
                                                                    <img src="<?php echo esc_url( $attachment_image[0] ); ?>" alt="<?php esc_attr_e( 'Image', 'pomana' ); ?>">
                                                                    <a href="#" class="action-delete" title="<?php esc_attr_e( 'Delete image', 'pomana' ); ?>">&times;</a>
                                                                </li>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                        <li class="add-image add-product-images tips" data-title="<?php esc_html_e( 'Add gallery image', 'pomana' ); ?>">
                            ...
                            <?php #Begin: Blue Box Pomana Lottery hook ?>
                            <?php do_action('pomana_dokan_edit_product_before_short_description', $post->ID); ?>
                            <?php #End: Blue Box Pomana Lottery hook ?>


                            <div class="dokan-product-short-description">
                                <label for="post_excerpt" class="form-label"><?php esc_html_e( 'Short Description', 'pomana' ); ?></label>
                            ...
                            <div class="dokan-product-description">
                                <label for="post_content" class="form-label"><?php esc_html_e( 'Description', 'pomana' ); ?></label>
                            ...
                            <input type="hidden" name="dokan_update_product" value="<?php esc_attr_e( 'Save Product', 'pomana' ); ?>"/>
                            <input type="submit" name="dokan_update_product" class="dokan-btn dokan-btn-theme dokan-btn-lg dokan-right" value="<?php esc_attr_e( 'Save Product', 'pomana' ); ?>"/>
